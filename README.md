...
- The `/tasks` page (`ScheduledJobsBoard`) and `GET/POST /api/scheduled-tasks`, `PATCH/DELETE /api/scheduled-tasks/:id`, `GET /api/scheduled-tasks/:id/runs` use the same service as the chat tools.
